...
CITESEER_TOTAL_TRAIN_EXAMPLES = CORA_NUMBER_OF_TRAIN_EXAMPLES_PER_CLASS * CORA_NUM_CLASSES

CITESEER_TRAIN_RANGE = [0, CORA_TOTAL_TRAIN_EXAMPLES]
CITESEER_VAL_RANGE = [CORA_TOTAL_TRAIN_EXAMPLES, CORA_TOTAL_TRAIN_EXAMPLES + 500]
CITESEER_TEST_RANGE = [1708, 1708 + 1000]
