...
CORA_TOTAL_TRAIN_EXAMPLES = CORA_NUMBER_OF_LABELS_PER_CLASS * CORA_NUM_CLASSES

CORA_TRAIN_RANGE = [0, CORA_TOTAL_TRAIN_EXAMPLES]
CORA_VAL_RANGE = [CORA_TOTAL_TRAIN_EXAMPLES, CORA_NUM_CLASSES * CORA_NUM_CLASSES + 500]
