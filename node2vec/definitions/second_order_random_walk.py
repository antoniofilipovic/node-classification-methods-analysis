...
from node2vec.util import graph
...
class SecondOrderRandomWalk:
    ...
    def sample_node_walks(self, graph: graph.Graph) -> List[List[int]]:
        """
    ...
    def sample_walk(self, graph: graph.Graph, start_node_id_int: int) -> List[int]:
        """
    ...
    def set_first_pass_transition_probs(self, graph: graph.Graph) -> None:
        """
    ...
    def calculate_edge_transition_probs(
        self, graph: graph.Graph, src_node_id: int, dest_node_id: int
    ) -> List[float]:
        """
    ...
    def set_graph_transition_probs(self, graph: graph.Graph) -> None:
        """
